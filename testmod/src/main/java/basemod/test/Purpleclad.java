...
public class Purpleclad extends CustomPlayer {
	...
	public Purpleclad(String name) {
		super(name, CharacterEnumPatch.THE_PURPLECLAD, null, null,
				new SpineAnimation("images/characters/ironclad/idle/skeleton.atlas",
						"images/characters/ironclad/idle/skeleton.json", 1.0F));

		this.dialogX = (this.drawX + 0.0F * Settings.scale);
		this.dialogY = (this.drawY + 220.0F * Settings.scale);

		initializeClass(null, "images/characters/ironclad/shoulder2.png", "images/characters/ironclad/shoulder.png",
	...
	public CharSelectInfo getLoadout() {
		return new CharSelectInfo("The Purpleclad",
				"A long-lost survivor of the Ironclads. Decided to dye himself purple.",
				75, 75, 0, 99, 5,
